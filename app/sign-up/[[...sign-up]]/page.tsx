      ...
      <div style={{ marginBottom:"16px", width:"100%", maxWidth:"480px", background:"white", borderRadius:"16px", border:"1px solid #e5e7eb", padding:"16px 20px" }}>
        <label style={{ display:"flex", alignItems:"flex-start", gap:"12px", cursor:"pointer" }}>
          <input
            ...
            style={{ marginTop:"2px", width:"18px", height:"18px", accentColor:"#00885f", flexShrink:0, cursor:"pointer" }}
          />
          <span style={{ fontSize:"14px", color:"#374151", lineHeight:"1.6" }}>
            Li e aceito os{" "}
            <a href="/termos" target="_blank" rel="noopener noreferrer"
              onClick={e => e.stopPropagation()}
              style={{ color:"#00885f", textDecoration:"underline" }}>Termos de Uso</a>
            {" "}e a{" "}
            <a href="/privacidade" target="_blank" rel="noopener noreferrer"
              onClick={e => e.stopPropagation()}
              style={{ color:"#00885f", textDecoration:"underline" }}>Política de Privacidade</a>
            , incluindo o tratamento de dados conforme a <strong>LGPD</strong>.
          </span>
        </label>
        {accepted && (
          <p style={{ marginTop:"8px", fontSize:"12px", color:"#00885f", fontWeight:"600", paddingLeft:"30px" }}>
