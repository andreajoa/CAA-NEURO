...
const styles = StyleSheet.create({
  ...
  logo: { fontSize: 18, fontWeight: "bold", color: "#C76B4A", marginBottom: 4 },
  ...
  sessionCard: { backgroundColor: "#f9fafb", borderRadius: 4, padding: 10, marginBottom: 8, borderLeftWidth: 3, borderLeftColor: "#C76B4A" },
  sessionDate: { fontSize: 9, color: "#6b7280", marginBottom: 3 },
  sessionText: { fontSize: 10, color: "#374151", lineHeight: 1.5 },
  sessionLabel: { fontSize: 9, fontWeight: "bold", color: "#C76B4A", marginTop: 3 },
  statBox: { flex: 1, backgroundColor: "#f0fdf4", borderRadius: 4, padding: 8, marginRight: 6, alignItems: "center" },
  statNum: { fontSize: 20, fontWeight: "bold", color: "#C76B4A" },
  ...
  badge: { fontSize: 9, color: "#C76B4A", marginBottom: 2 },
});
