      ...
      <div style={{ maxWidth:1200, margin:"0 auto" }}>
        <div style={{ display:"grid", gridTemplateColumns:"2fr 1fr 1fr 1fr", gap:40, marginBottom:40 }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
            <p style={{ color:"rgba(255,255,255,0.4)", fontSize:12, fontWeight:700, marginBottom:6, letterSpacing:1, textTransform:"uppercase" }}>Plataforma</p>
            {[["Recursos","/recursos"],["Como funciona","/como-funciona"],["Benefícios","/beneficios"],["Depoimentos","/depoimentos"]].map(([l,h]) => (
              <Link key={h} href={h} style={{ color:"rgba(255,255,255,0.7)", fontSize:14, textDecoration:"none" }}>{l}</Link>
            ))}
          </div>
          <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
            <p style={{ color:"rgba(255,255,255,0.4)", fontSize:12, fontWeight:700, marginBottom:6, letterSpacing:1, textTransform:"uppercase" }}>Para quem</p>
            {[["Fonoaudiólogos","/para-quem"],["Terapeutas Ocupacionais","/para-quem"],["Psicólogos","/para-quem"],["Educadores","/para-quem"],["Prefeituras","/para-quem"]].map(([l,h]) => (
              <Link key={l} href={h} style={{ color:"rgba(255,255,255,0.7)", fontSize:14, textDecoration:"none" }}>{l}</Link>
            ))}
          </div>
          <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
            <p style={{ color:"rgba(255,255,255,0.4)", fontSize:12, fontWeight:700, marginBottom:6, letterSpacing:1, textTransform:"uppercase" }}>Suporte</p>
        ...
        <div style={{ borderTop:"0.5px solid rgba(255,255,255,0.1)", paddingTop:24, display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:12 }}>
          ...
          <p style={{ color:"rgba(255,255,255,0.35)", fontSize:13 }}>
            Dados protegidos pela LGPD · <Link href="/seguranca" style={{ color:"rgba(255,255,255,0.6)", textDecoration:"underline" }}>Política de Segurança</Link>
          </p>
        </div>
      </div>
    </footer>
