...
export default function PublicFooter() {
  return (
    <footer style={{ background:"#F2E8E1", color:"#1B2D5B", padding:"48px 40px 32px", marginTop:"auto" }}>
      <div style={{ maxWidth:1200, margin:"0 auto" }}>
        <div style={{ display:"grid", gridTemplateColumns:"2fr 1fr 1fr 1fr", gap:40, marginBottom:40 }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
            <p style={{ color:"rgba(27,45,91,0.5)", fontSize:12, fontWeight:700, marginBottom:6, letterSpacing:1, textTransform:"uppercase" }}>Plataforma</p>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
            <p style={{ color:"rgba(27,45,91,0.5)", fontSize:12, fontWeight:700, marginBottom:6, letterSpacing:1, textTransform:"uppercase" }}>Para quem</p>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
            <p style={{ color:"rgba(27,45,91,0.5)", fontSize:12, fontWeight:700, marginBottom:6, letterSpacing:1, textTransform:"uppercase" }}>Suporte</p>
