...
export default function SegurancaPage() {
  const s = { fontFamily:"system-ui,sans-serif", color:"#071b2c" };
  const section = { maxWidth:"820px", margin:"0 auto", padding:"0 24px 64px" };
  const h2 = { fontSize:"24px", fontWeight:"800", color:"#071b2c", margin:"0 0 16px", display:"flex", alignItems:"center", gap:"10px" };
    ...
    <div style={s}>
      ...
      <div style={{ background:"#f9fafb", padding:"64px 0" }}>
        <div style={section}>
          ...
          <div style={card}>
            <h2 style={h2}><Lock size={22} color="#00885f" /> Criptografia de ponta a ponta</h2>
            ...
            <div style={{ display:"flex", gap:"10px", flexWrap:"wrap" }}>
              <span style={badge("#00885f")}>✓ AES-256-GCM</span>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(220px,1fr))", gap:"14px", margin:"0 0 16px" }}>
              {[
                ...
                <div key={title} style={{ background:"#f9fafb", borderRadius:"10px", padding:"16px", border:"1px solid #e5e7eb" }}>
                  <div style={{ fontWeight:"700", fontSize:"14px", color:"#071b2c", marginBottom:"6px" }}>{title}</div>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(200px,1fr))", gap:"10px" }}>
              {["Acesso aos seus dados","Correção de informações","Exclusão a qualquer momento","Portabilidade (exportação)","Revogar consentimento","Ver quem acessou"].map(d => (
                <div key={d} style={{ display:"flex", alignItems:"center", gap:"8px", fontSize:"14px", color:"#374151" }}>
                  <CheckCircle size={16} color="#00885f" /> {d}
                </div>
              ))}
            </div>
          </div>
          ...
          <div style={{ background:"#071b2c", borderRadius:"20px", padding:"40px", textAlign:"center", color:"white" }}>
            <ShieldCheck size={40} color="#4ec9a0" style={{ margin:"0 auto 16px", display:"block" }} />
            ...
            <Link href="/suporte" style={{ background:"#00885f", color:"white", padding:"13px 32px", borderRadius:"10px", textDecoration:"none", fontSize:"15px", fontWeight:"700", display:"inline-block" }}>
              Falar com a equipe
            </Link>
          </div>
